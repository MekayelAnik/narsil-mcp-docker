...
VERSION_RANGE_INPUT="${VERSION_RANGE_INPUT:-}"
CLIENT_VERSION_RANGE="${CLIENT_VERSION_RANGE:-}"
...
VERSION_RANGE="$(trim "${VERSION_RANGE_INPUT:-}")"
if [[ -z "$VERSION_RANGE" ]]; then
    VERSION_RANGE="$(trim "${CLIENT_VERSION_RANGE:-}")"
fi
